...
async function main() {
  ...
  // 9. Crear configuración de presupuestos de Autónomos (BASU)
  ...
  console.log(`✅ Configuración de presupuestos creada con:`);
  ...
  console.log(`  - 11 servicios adicionales mensuales/puntuales\n`);
  ...
  console.log(`  - 1 configuración de presupuestos (5+6+7+7+11 = 36 registros relacionados)\n`);
}
